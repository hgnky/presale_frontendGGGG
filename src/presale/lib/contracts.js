...
import aRIPMigration from './abi/aRIPMigration.json'
import aRIP from './abi/aRIP.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    // this.aRIPMigration = new this.web3.eth.Contract(aRIPMigration)
    this.aRIP = new this.web3.eth.Contract(aRIP)
  ...
  setProvider(provider, networkId) {
    ...
    // setProvider(this.aRIPMigration, contractAddresses.aRIPMigration[networkId])
    setProvider(this.aRIP, contractAddresses.aRIP[networkId])
  }

  setDefaultAccount(account) {
    this.PresaleErc20.options.from = account
    // this.aRIPMigration.options.from = account
    this.aRIP.options.from = account
  }
