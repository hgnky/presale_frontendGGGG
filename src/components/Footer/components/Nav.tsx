...
const Nav: React.FC = () => {
  return (
    <StyledNav>
      <StyledLink target="_blank" href="https://discord.gg/JjFnvNz2Vy">
        <i className="fab fa-discord" style={{fontSize:'36px'}}></i>
      </StyledLink>
      <StyledLink target="_blank" href="https://t.me/RdaoRIP">
